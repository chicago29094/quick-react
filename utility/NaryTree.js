...
class NaryNode {
    ...
    /**
     * @constructor
     * @param {object} childObj - The object to be inserted at the new n-ary node 
     */
     ...
     * @returns {array} children - an array of child nodes
     */
    get children() {
     ...
     * @returns {object} value - the object stored in this node
     */
    get value() {
        return this._value;
    }
     ...
     * @param {array} newArray - a new array of child object refrences
     */
     ...
     * @param {object] newValue - the new object to store in this node
     */
    set value(newValue) {
...
class NaryTree {
     ...
     * @params {object} childObj - an object to store in the node
     ...
     * @params {object} childObj - an object to store in the node
     * @params {NaryNode} NaryNode object - the parent n-ary node
     * @returns {boolean} boolean value
     */ 
     ...
     * @params {object} childObj - an object to store in the node
     * @params {NaryNode} NaryNode object - the parent n-ary node
     * @params {number} position integer - the position number where the child should be included in the children array for this node
     * @returns {boolean} boolean value
     */ 
     ...
     * Returns a boolean value
     * @params {object} an object stored in any node
     * @params {NaryNode} parentNode object - the parent n-ary node
     * @returns {boolean} boolean value 
     */
     ...
     * @returns {NaryNode} NaryNode object - returns a reference to the root node
     */
    get root() {
        return this._root;
    }
     ...
     * @params {object} object - an object stored in any node
     * @returns {boolean} boolean value      
     * */
    get(obj) {
     ...
     * @params {object} object - an object store in a node
     * @returns {NaryNode} NaryNode object - a reference to first node found containing a reference to the specified object 
     */
    getNode(obj) {
     ...
     * In no object parameter is specified, return the root node object
     * In an object is specified, get returns the first occurrence of the specified object using a level-order tree traversal iterator.
     * @params {object} {key:value} object - a property key and value object
     * @returns {object} object - returns the first object found containing the specified property and property value     
     */
     ...
     * getNode returns the n-ary tree node reference for the first occurrence of the specified object passed as an argument to the method.
     * @params {object} {key:value} object - a property key and value object
     * @returns {NaryNode} NaryNode object - returns the first node found containing an object with the specified property and property value     
     */
     ...
     * @returns {object} object - a reference to the object stored in the root node of the tree
     */
    getRootItem() {
        return this._root.value;
    }
     ...
     * @params {NaryNode} NaryNode object - an n-ary node present in this tree
     ...
     * @returns {boolean} boolean value - is the tree empty or not 
     */
    isEmpty() {
        return (this._size===0)
    }
     ...
     * @params {NaryNode} parentNode object - the parent n-ary node
     * @returns {iterator} iterator - a JavaScript iterator that iterates over this tree in level-order order starting from the referenced node      
     * 
     */ 
    * iterator(node) {
    ...
    * levelOrderIterator(node) {
     ...
     * @params {NaryNode} parentNode object - the parent n-ary node
     * @returns {iterator} iterator - a JavaScript iterator that iterates over this tree in pre-order order starting from the referenced node 
     */
    ...
    * @params {object} an object stored in any node
    * @params {NaryNode} NaryNode parent object - the parent n-ary node
    * @returns {boolean} boolean value 
    */
    remove(obj, parent) {
     ...
     * @params {NaryNode} NaryNode node object - the n-ary node to remove
     * @returns {boolean} boolean value
     */
    removeNode(naryNode) {
     ...
     * @params {object} an object stored in any node
     * @params {NaryNode} NaryNode parent node - the parent n-ary node
     * @returns {boolean} boolean value 
     */
     ...
     * @params {NaryNode} NaryNode node - an n-ary node positioned at the root of the subtree to remove
     * @returns {boolean} boolean value 
     */
     ...
     * @param (NaryNode) NaryNode object - an optional parameter specifying the root node of the tree or subtree to be printed as a string representation
     ...
     * @param (NaryNode) NaryNode object - an optional parameter specifying the root node of the tree or subtree to be output in a JSON representation
