...
class QuickReact {
     ...
     * @method
     * @param {string} userID - The registered Quick-React user's unique id, as assigned by MongoDB.
     * @param {string} projectID - The registered Quick-React user's unique project ID, as assigned by MongoDB
     * @param {Object} NaryTree tree - The tree of parsed values representing the structure of this Quick-React project
